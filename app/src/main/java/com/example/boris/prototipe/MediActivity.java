       ...
       /* NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view);
        ...
        findViewById(R.id.fab).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MediActivity.this, InsertMediActivity.class));
            }
        });*/

        Button botonsettings = (Button)findViewById(R.id.action_settings);
        botonsettings.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view)
            {
                startActivity(new Intent(MediActivity.this,SettingsActivity.class));
            }
        });
    }
